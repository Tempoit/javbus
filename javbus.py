...
def run(*arg):
    ...
    # 签到
    url = "https://www.seedmm.cyou/forum/home.php?mod=spacecp&ac=credit&op=log&suboperation=creditrulelog"
    headers = {
        'authority': 'www.seedmm.cyou',
        'method': 'GET',
        ...
        'Cookie': cookie,
        'referer': 'https://www.seedmm.cyou/forum/home.php?mod=spacecp'
    }
    try:
